...
## Project Structure
    ...
    ├── ideapros_llc_upgig_32956  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_upgig_32956`
...
2. Clone this repo and `cd ideapros_llc_upgig_32956`
